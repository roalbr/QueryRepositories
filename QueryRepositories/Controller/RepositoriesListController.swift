...
class RepositoriesListController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setupViewCode()
        title = "List of Repositories - GIT"
...
extension RepositoriesListController: RepositoriesListProtocol {
...
extension RepositoriesListController: UITableViewDelegate, UITableViewDataSource {
